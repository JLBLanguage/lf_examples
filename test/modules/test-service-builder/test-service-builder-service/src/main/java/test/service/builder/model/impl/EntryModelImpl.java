...
import test.service.builder.model.EntryModel;
import test.service.builder.model.EntrySoap;
...
/**
 * The base model implementation for the Entry service. Represents a row in the &quot;FOO_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	 ...
	 */
	public static final String TABLE_NAME = "FOO_Entry";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.test.service.builder.model.Entry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.test.service.builder.model.Entry"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.test.service.builder.model.Entry"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(test.service.builder.service.util.ServiceProps.get(
				"lock.expiration.time.test.service.builder.model.Entry"));
	...
	public String toXmlString() {
		...
		sb.append("test.service.builder.model.Entry");
