...
import test.service.builder.exception.NoSuchGuestbookException;
import test.service.builder.model.Guestbook;
import test.service.builder.model.impl.GuestbookImpl;
import test.service.builder.model.impl.GuestbookModelImpl;
import test.service.builder.service.persistence.GuestbookPersistence;
 ...
 * @see test.service.builder.service.persistence.GuestbookUtil
 * @generated
 */
@ProviderType
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE = "SELECT DISTINCT {guestbook.*} FROM FOO_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {FOO_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM FOO_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN FOO_Guestbook ON TEMP_TABLE.guestbookId = FOO_Guestbook.guestbookId";
	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE = "SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM FOO_Guestbook guestbook WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "guestbook";
	private static final String _FILTER_ENTITY_TABLE = "FOO_Guestbook";
	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";
	private static final String _ORDER_BY_ENTITY_TABLE = "FOO_Guestbook.";
