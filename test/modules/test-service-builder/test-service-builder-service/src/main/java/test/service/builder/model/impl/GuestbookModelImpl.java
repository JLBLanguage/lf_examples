...
import test.service.builder.model.GuestbookModel;
import test.service.builder.model.GuestbookSoap;
...
/**
 * The base model implementation for the Guestbook service. Represents a row in the &quot;FOO_Guestbook&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class GuestbookModelImpl extends BaseModelImpl<Guestbook>
	 ...
	 */
	public static final String TABLE_NAME = "FOO_Guestbook";
	...
	public static final String TABLE_SQL_CREATE = "create table FOO_Guestbook (uuid_ VARCHAR(75) null,guestbookId LONG not null primary key,groupId LONG,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table FOO_Guestbook";
	public static final String ORDER_BY_JPQL = " ORDER BY guestbook.guestbookId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY FOO_Guestbook.guestbookId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.test.service.builder.model.Guestbook"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.test.service.builder.model.Guestbook"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(test.service.builder.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.test.service.builder.model.Guestbook"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(test.service.builder.service.util.ServiceProps.get(
				"lock.expiration.time.test.service.builder.model.Guestbook"));
	...
	public String toXmlString() {
		...
		sb.append("test.service.builder.model.Guestbook");
