...
public class EntryLocalServiceWrapper implements EntryLocalService,
	...
	*/
	@Override
	public test.service.builder.model.Entry addEntry(
		test.service.builder.model.Entry entry) {
		return _entryLocalService.addEntry(entry);
	}

	@Override
	public test.service.builder.model.Entry addEntry(long userId,
	...
	*/
	@Override
	public test.service.builder.model.Entry createEntry(long entryId) {
	...
	*/
	@Override
	public test.service.builder.model.Entry deleteEntry(
		test.service.builder.model.Entry entry) {
	...
	*/
	@Override
	public test.service.builder.model.Entry deleteEntry(long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	@Override
	public test.service.builder.model.Entry fetchEntry(long entryId) {
	...
	*/
	@Override
	public test.service.builder.model.Entry fetchEntryByUuidAndGroupId(
	...
	*/
	@Override
	public java.util.List<test.service.builder.model.Entry> getEntries(
		int start, int end) {
	...
	*/
	@Override
	public java.util.List<test.service.builder.model.Entry> getEntriesByUuidAndCompanyId(
	...
	*/
	@Override
	public test.service.builder.model.Entry getEntry(long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public test.service.builder.model.Entry getEntryByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public test.service.builder.model.Entry updateEntry(
		test.service.builder.model.Entry entry) {
		return _entryLocalService.updateEntry(entry);
	}

	@Override
	public test.service.builder.model.Entry updateEntry(long userId,
	...
	@Override
	public test.service.builder.model.Entry updateStatus(long userId,
