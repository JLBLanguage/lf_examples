...
public class GuestbookLocalServiceWrapper implements GuestbookLocalService,
	...
	*/
	@Override
	public test.service.builder.model.Guestbook addGuestbook(
		test.service.builder.model.Guestbook guestbook) {
		return _guestbookLocalService.addGuestbook(guestbook);
	}

	@Override
	public test.service.builder.model.Guestbook addGuestbook(long userId,
	...
	*/
	@Override
	public test.service.builder.model.Guestbook createGuestbook(
		long guestbookId) {
	...
	*/
	@Override
	public test.service.builder.model.Guestbook deleteGuestbook(
		test.service.builder.model.Guestbook guestbook) {
	...
	*/
	...
	@Override
	public test.service.builder.model.Guestbook fetchGuestbook(long guestbookId) {
	...
	*/
	@Override
	public test.service.builder.model.Guestbook fetchGuestbookByUuidAndGroupId(
	...
	*/
	@Override
	public test.service.builder.model.Guestbook getGuestbook(long guestbookId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public test.service.builder.model.Guestbook getGuestbookByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public java.util.List<test.service.builder.model.Guestbook> getGuestbooks(
		int start, int end) {
	...
	*/
	@Override
	public java.util.List<test.service.builder.model.Guestbook> getGuestbooksByUuidAndCompanyId(
	...
	*/
	@Override
	public test.service.builder.model.Guestbook updateGuestbook(
		test.service.builder.model.Guestbook guestbook) {
		return _guestbookLocalService.updateGuestbook(guestbook);
	}

	@Override
	public test.service.builder.model.Guestbook updateGuestbook(long userId,
	...
	@Override
	public test.service.builder.model.Guestbook updateStatus(long userId,
