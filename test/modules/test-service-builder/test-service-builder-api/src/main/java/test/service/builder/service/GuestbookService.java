...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=foo", "json.web.service.context.path=Guestbook"}, service = GuestbookService.class)
@ProviderType
...
public interface GuestbookService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GuestbookServiceUtil} to access the guestbook remote service. Add custom service methods to {@link test.service.builder.service.impl.GuestbookServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
